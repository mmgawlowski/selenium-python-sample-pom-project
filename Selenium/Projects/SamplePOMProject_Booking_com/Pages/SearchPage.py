...
class SearchPage(BasePage):
    ...
    def check_for_empty_query(self):
        try:
            self.driver.find_element_by_id(Locators.empty_query_alert_id).is_displayed()
    ...
    # Method check if chosen destination e.g. city or place e.g. hotel is displayed on result page.
